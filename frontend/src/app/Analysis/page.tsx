  ...
  return (
    <div className="container font-sans m-auto p-4">
      <div className="grid mb-4 gap-4 grid-cols-12">
        {/* Card 1: Line Chart */}
        <div className="card flex flex-col items-center bg-white p-4 col-span-8 shadow-md rounded-lg" style={{"width":"100%"}}>
      ...
      <div className="grid my-4 grid-cols-12 gap-4">
        {/* Card 1: Line Chart */}
        <div className="card flex flex-col bg-white p-4 col-span-7 items-center shadow-md rounded-lg">
         ...
         <div className="card flex flex-col justify-center col-span-5 items-center align-middle bg-white p-4 shadow-md end-0 rounded-lg">
          <h2 className="text-xl font-semibold mb-2">% of Housing Units in Proximity </h2>
          <Heatmap />
        </div>
      </div>
